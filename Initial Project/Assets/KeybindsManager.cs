...
public class KeybindsManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI upText, leftText, downText, rightText, escapetext, attackupText, attackleftText, attackdownText, attackrightText, form1Text, form2Text, form3Text, switchAText, switchBText; //Accessing text on menu buttons
